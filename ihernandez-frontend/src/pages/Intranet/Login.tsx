                    ...
                    <div className="auth-left-inner">
                        ...
                        <div className="auth-heading-block">
                            ...
                            <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "0.88rem", lineHeight: 1.65, marginTop: "0.7rem" }}>
                                Sigue estos pasos para acceder a tu panel y gestionar tu despedida perfecta.
                            </p>
                        </div>

                        <div className="auth-steps">
                            <StepItem number={1} text="Identifícate" active delay={340} />
                            <StepItem number={2} text="Accede al panel" delay={440} />
                            <StepItem number={3} text="Gestiona tu evento" delay={540} />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="auth-form-container">
                        ...
                        <div style={{ marginTop: "2rem", display: "flex", flexDirection: "column", gap: "0.75rem", alignItems: "center" }}>
                            <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.88rem", margin: 0 }}>
                                ¿No tienes cuenta?{" "}
                                <Link to="/intranet/register" style={{ color: "#DB2777", fontWeight: 700, textDecoration: "none" }}>
                                    Regístrate aquí
                                </Link>
                            </p>
